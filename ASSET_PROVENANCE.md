...
| Public asset | Source | Rights and scope | Transformation |
| --- | --- | --- | --- |
| `assets/hero-bg.avif` | FlightSweeper public landing-page asset `apps/web/public/hero-bg-generated-medium.avif` | FinSync LLC-owned FlightSweeper brand artwork, approved for this public FlightSweeper challenge repository and deployment | Renamed only |
| `assets/hero-bg-mobile.avif` | FlightSweeper public landing-page asset `apps/web/public/hero-bg-generated-mobile.avif` | FinSync LLC-owned FlightSweeper brand artwork, approved for this public FlightSweeper challenge repository and deployment | Renamed only |
